...
export const strings = {
    en: {
        ...
        windowsVirtualCableListenNote: "One-time step after installing: open Windows Sound Settings → Recording tab → \"CABLE Output\" → Properties → Listen tab → check \"Listen to this device\" → set the playback device to your real headphones/speakers. That's what lets you still hear an excluded app.",
    ...
    ru: {
        ...
        windowsVirtualCableListenNote: "Разовый шаг после установки: открой настройки звука Windows → вкладка «Запись» → «CABLE Output» → Свойства → вкладка «Прослушать» → включи «Прослушать с данного устройства» → выбери в качестве устройства воспроизведения свои реальные наушники/колонки. Именно это позволит тебе слышать исключённое приложение.",
