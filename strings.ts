...
export const strings = {
    en: {
        ...
        macNotFoundNoCommand: "BlackHole not found. Install it with Homebrew (run \"brew install --cask blackhole-2ch\" in Terminal), then restart Discord.",
    ...
    ru: {
        ...
        macNotFoundNoCommand: "BlackHole не найден. Установи его через Homebrew (выполни \"brew install --cask blackhole-2ch\" в Terminal), затем перезапусти Discord.",
