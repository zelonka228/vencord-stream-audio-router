...
export const strings = {
    en: {
        ...
        windowsVirtualCableListenNote: "One remaining step so you can still hear an excluded app: turn on \"Listen to this device\" on the cable's recording side, pointed at your real headphones/speakers.",
        ...
        windowsCheckingListen: "Checking audio Listen configuration...",
        windowsListenConfigured: "Configured - you'll hear excluded apps through your headphones automatically.",
        windowsConfigureListenButton: "Configure automatically (one more admin prompt)",
        windowsListenConfiguredSuccess: "Done. Excluded apps will now be audible through your headphones again.",
        windowsManualListenHeading: "Or configure it yourself: open Windows Sound Settings → Recording tab → \"CABLE Output\" → Properties → Listen tab → check \"Listen to this device\" → set the playback device to your real headphones/speakers.",
    ...
    ru: {
        ...
        windowsVirtualCableListenNote: "Остался один шаг, чтобы ты продолжал слышать исключённое приложение: включить «Прослушать с данного устройства» на записывающей стороне кабеля, указав свои реальные наушники/колонки.",
        ...
        windowsCheckingListen: "Проверка настройки прослушивания...",
        windowsListenConfigured: "Настроено — теперь ты автоматически будешь слышать исключённые приложения через наушники.",
        windowsConfigureListenButton: "Настроить автоматически (ещё один запрос прав администратора)",
        windowsListenConfiguredSuccess: "Готово. Исключённые приложения снова будут слышны через наушники.",
        windowsManualListenHeading: "Или настрой сам: открой настройки звука Windows → вкладка «Запись» → «CABLE Output» → Свойства → вкладка «Прослушать» → включи «Прослушать с данного устройства» → выбери в качестве устройства воспроизведения свои реальные наушники/колонки.",
